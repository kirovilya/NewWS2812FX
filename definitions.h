...
uint8_t randomModes[] = {FX_MODE_MULTI_DYNAMIC, FX_MODE_RAINBOW, FX_MODE_RAINBOW_CYCLE, FX_MODE_FADE, FX_MODE_THEATER_CHASE_RAINBOW, 
FX_MODE_RUNNING_LIGHTS, FX_MODE_CHASE_RANDOM, FX_MODE_FIREWORKS_RANDOM, FX_MODE_EXT_CIRCLE, FX_MODE_EXT_LARSON_SCANNER, FX_MODE_EXT_FIREWORKS_RANDOM, FX_MODE_EXT_STAR};
//uint8_t randomModes[] = {FX_MODE_EXT_STAR};
